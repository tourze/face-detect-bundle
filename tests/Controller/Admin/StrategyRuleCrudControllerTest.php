...
class StrategyRuleCrudControllerTest extends TestCase
{
    private StrategyRuleCrudController $controller;
    ...
    public function test_get_entity_fqcn_returns_correct_class(): void
    {
        ...
        // Assert
        $this->assertSame(StrategyRule::class, $result);
    }
    ...
    public function test_controller_class_is_properly_structured(): void
    {
        ...
        // 验证有正确的命名空间
        $this->assertSame('Tourze\FaceDetectBundle\Controller\Admin\StrategyRuleCrudController', $reflectionClass->getName());
    }
    ...
    {
        $this->controller = new StrategyRuleCrudController();
    }
}
